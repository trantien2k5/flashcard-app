...
let reviewsDoneLog = {}; // 'YYYY-MM-DD' -> số lượt ôn thẻ ĐANG ở trạng thái review (chỉ để hiển thị "Đã ôn X/Y hôm nay" — ôn tập KHÔNG có giới hạn/ngày)
...
let settings = {
  ...
  newWordsPerDay: 10, // hiện ra UI dưới tên "Mục tiêu mỗi ngày" — CHỈ giới hạn này có cap/ngày, ôn tập thì không
