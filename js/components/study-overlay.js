/* ============================================================
   ...
   Phát âm (speak/prefetchAudio...) nằm ở components/study-audio.js — nạp TRƯỚC file
   này.
   Depends on: core/*, services/vocabulary.js, algorithms/fsrs-scheduler.js,
               algorithms/fsrs-queries.js, components/study-audio.js (speak, prefetchAudio,
               resetAudioCache), core/app.js (activeTab, switchTab)
   ============================================================ */
